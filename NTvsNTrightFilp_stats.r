...
NT3 <- read.csv(
  "2.datasets_panel/ES3_flip/ES3_peaks_notranscribed_genes_distance_breakpoint_r_flip",
  header = F, sep = "\t")

NT4 <- read.csv(
  "2.datasets_panel/ES4_flip/ES4_peaks_notranscribed_genes_distance_breakpoint_r_flip",
  header = F, sep = "\t")

NT5 <- read.csv(
  "2.datasets_panel/ES5_flip/ES5_peaks_nontrancribed_genes_distance_breakpoint_r_flip",
  header = F, sep = "\t")

NTLS <- read.csv(
  "2.datasets_panel/LS_flip/LS_peaks_nontrancribed_genes_distance_breakpoint_r_flip",
  header = F, sep = "\t")

NTMS <- read.csv(
  "2.datasets_panel/MS_flip/MS_peaks_nontrancribed_genes_distance_breakpoint_r_flip",
  header = F, sep = "\t")
