...
#File: TH2HvsTH2HrightFlip_stats.r
...
TH2H3 <- read.csv(
  "2.datasets_panel/ES3_flip/ES3_peaks_transcribed_genes_h2h_distance_breakpoint_r_flip",
  header = F, sep = "\t")

TH2H4 <- read.csv(
  "2.datasets_panel/ES4_flip/ES4_peaks_h2h_genes_distance_breakpoint_r_flip",
  header = F, sep = "\t")

TH2H5 <- read.csv(
  "2.datasets_panel/ES5_flip/ES5_peaks_h2h_genes_distance_breakpoint_r_flip",
  header = F, sep = "\t")

TH2HLS <- read.csv(
  "2.datasets_panel/LS_flip/LS_peaks_h2h_genes_distance_breakpoint_r_flip",
  header = F, sep = "\t")

TH2HMS <- read.csv(
  "2.datasets_panel/MS_flip/MS_peaks_h2h_genes_distance_breakpoint_r_flip",
  header = F, sep = "\t")
