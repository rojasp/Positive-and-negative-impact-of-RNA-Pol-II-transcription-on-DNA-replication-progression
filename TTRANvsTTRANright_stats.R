...
#File: TTRANvsTTRANright_stats.r
...
TTRAN3 <- read.csv(
  "2.datasets_panel/ES3/ES3_peaks_transcribed_genes_tran_distance_breakpoint_r",
  header = F, sep = "\t")

TTRAN4 <- read.csv(
  "2.datasets_panel/ES4/ES4_peaks_transcribed_genes_tran_distance_breakpoint_r",
  header = F, sep = "\t")
