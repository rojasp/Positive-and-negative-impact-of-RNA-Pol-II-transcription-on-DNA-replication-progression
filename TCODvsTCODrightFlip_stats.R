...
#File: TCODvsTCODrightFlip_stats.r
...
TCOD3 <- read.csv(
  "2.datasets_panel/ES3_flip/ES3_peaks_transcribed_genes_cod_distance_breakpoint_r_flip",
  header = F, sep = "\t")

TCOD4 <- read.csv(
  "2.datasets_panel/ES4_flip/ES4_peaks_cod_genes_distance_breakpoint_r_flip",
  header = F, sep = "\t")

TCOD5 <- read.csv(
  "2.datasets_panel/ES5_flip/ES5_peaks_cod_genes_distance_breakpoint_r_flip",
  header = F, sep = "\t")

TCODLS <- read.csv(
  "2.datasets_panel/LS_flip/LS_peaks_cod_genes_distance_breakpoint_r_flip",
  header = F, sep = "\t")

TCODMS <- read.csv(
  "2.datasets_panel/MS_flip/MS_peaks_cod_genes_distance_breakpoint_r_flip",
  header = F, sep = "\t")
