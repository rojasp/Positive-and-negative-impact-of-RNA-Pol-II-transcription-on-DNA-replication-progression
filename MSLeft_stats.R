...
NT <- read.csv(
  "2.datasets_panel/MS/MS_peaks_nontranscribed_genes_distance_breakpoint_l",
  header = F, sep = "\t")
...
TH2H <- read.csv(
  "2.datasets_panel/MS/MS_peaks_transcribed_genes_h2h_distance_breakpoint_l",
  header = F, sep = "\t")

TTRAN <- read.csv(
  "2.datasets_panel/MS/MS_peaks_transcribed_genes_tran_distance_breakpoint_l",
  header = F, sep = "\t")
