...
#File: TTRANvsTTRANleftFlip_stats.r
...
TTRAN3 <- read.csv(
  "2.datasets_panel/ES3_flip/ES3_peaks_transcribed_genes_tran_distance_breakpoint_l_flip",
  header = F, sep = "\t")

TTRAN4 <- read.csv(
  "2.datasets_panel/ES4_flip/ES4_peaks_tran_genes_distance_breakpoint_l_flip",
  header = F, sep = "\t")

TTRAN5 <- read.csv(
  "2.datasets_panel/ES5_flip/ES5_peaks_tran_genes_distance_breakpoint_l_flip",
  header = F, sep = "\t")

TTRANLS <- read.csv(
  "2.datasets_panel/LS_flip/LS_peaks_tran_genes_distance_breakpoint_l_flip",
  header = F, sep = "\t")

TTRANMS <- read.csv(
  "2.datasets_panel/MS_flip/MS_peaks_tran_genes_distance_breakpoint_l_flip",
  header = F, sep = "\t")
