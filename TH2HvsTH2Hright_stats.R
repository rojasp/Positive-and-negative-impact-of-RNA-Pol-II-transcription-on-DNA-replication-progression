...
TH2H3 <- read.csv(
  "2.datasets_panel/ES3/ES3_peaks_transcribed_genes_h2h_distance_breakpoint_r",
  header = F, sep = "\t")

TH2H4 <- read.csv(
  "2.datasets_panel/ES4/ES4_peaks_transcribed_genes_h2h_distance_breakpoint_r",
  header = F, sep = "\t")
